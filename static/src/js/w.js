...
class Wizard {
    ...
    constructor(args) {
        ...
        let opts = {
            ...
            next: (args != undefined && args.hasOwnProperty("next")) ? args.next : "<i class='fa fa-angle-double-right'></i> Siguiente",
            prev: (args != undefined && args.hasOwnProperty("prev")) ? args.prev : "<i class='fa fa-angle-double-left'></i> Anterior",
            finish: (args != undefined && args.hasOwnProperty("finish")) ? args.finish : "<i class='fa fa-paper-plane'></i> Finalizar",
        }
