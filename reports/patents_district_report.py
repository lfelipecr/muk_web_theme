...
class PrintReportPatentsDistrictFinancial(models.AbstractModel):
    _name = 'report.l10n_cr_municipality_extend.report_district_financial'
    _description = 'Reporte de Patentes por Distrito'
    ...
    def _response_sql(self,data):
        ...
        sql = """
                select
                    ...
                    p.yearly_payment
                    order by 1 asc
              """.format(p_fecha, p_fecha1, p_fecha2, p_distrito, p_distrito_ids)
